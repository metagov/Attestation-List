...
const ToggleButton = ({ isActive, onToggle }) => {
    return (
        <button
            onClick={onToggle}
            className={`transition-colors duration-300 ${isActive ? 'bg-blue-500' : 'bg-gray-300'} rounded-full p-2`}
        >
            {isActive ? 'ON' : 'OFF'}
        </button>
    );
                            ...
                            {networkIdFields.map((item, index) => (
                                ...
                                <div key={item.id} className="grid grid-cols-1 gap-y-8">
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-2">
                                            <select {...register(`networkIds.${index}.value`, { required: true })} className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-black-600 sm:max-w-xs sm:text-sm sm:leading-6">
                                                <option value="1">Ethereum</option>
                                                <option value="10">Optimism</option>
                                                <option value="137">Polygon</option>
                                            </select>
                                        </div>
                                        {errors.networkIds?.[index]?.value && <p>{errors.networkIds[index].value.message}</p>}
                                    ...
                                    <div>
                                        ...
                                        {errors.schemaDescriptions?.[index]?.value && <p>{errors.schemaDescriptions[index].value.message}</p>}
                                    </div>
                                </div>
                            ))}
                        ...
                        <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div className="sm:col-span-3">
                                ...
                                <div className="mt-2">
                                    ...
                                    />
                                    {errors.issuerName && <p>{errors.issuerName.message}</p>}
                            ...
                            <div className="col-span-full">
                                ...
                                <div className="mt-2">
                                    <textarea
                                        ...
                                        defaultValue={''}
                                    />
                                    {errors.issuerDescription && <p>{errors.issuerDescription.message}</p>}
                            ...
                            <div className="sm:col-span-4">
                                ...
                                <div className="mt-2">
                                    ...
                                    {errors.logoUri && <p>{errors.logoUri.message}</p>}
                            ...
                            <div className="sm:col-span-4">
                                ...
                                <div className="mt-2">
                                    ...
                                    {errors.apiDocsUri && <p>{errors.apiDocsUri.message}</p>}
