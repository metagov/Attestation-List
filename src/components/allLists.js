...
export default function AllLists() {
  ...
  return (
    <section className="min-h-screen w-full py-10 px-4 sm:px-10 grid gap-6">
      <Search handleChange={handleChange} value={value} setValue={setValue} />

      <div className="overflow-y-auto h-[calc(100vh-10rem)] px-5 sm:px-0 mx-auto max-w-6xl">
        {loading ? (
          <div className="flex justify-center items-center">
            <div role="status">
              <svg aria-hidden="true" className="inline w-8 h-8 text-gray-50 animate-spin dark:text-gray-600 fill-indigo-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
